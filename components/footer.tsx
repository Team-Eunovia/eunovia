...
export const Footer = () => {
  return (
    <footer className="bg-[#141414] w-full md:max-w-[77rem] mx-auto md:rounded-t-xl p-4 md:p-10 space-y-4 mt-20">
      ...
      <div className="text-xs text-muted-foreground leading-5">
        <p>
          (주)유노비아 | 대표자: 김봉민 | 사업자번호: 123-45-67899 사업자 정보
          확인
        </p>
        <p>
          통신판매업: 2025-신림0B-1234 | 개인정보보호책임자: 한봉훈 | 이메일:
          jws970306@eunovia.com
        </p>
        <p>
          전화번호: 070-0000-0000 | 주소:경기도 성남시 분당구 판교로 123길,
          000호
        </p>
      </div>
    </footer>
